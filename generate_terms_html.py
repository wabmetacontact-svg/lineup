...
<title>Terms &amp; Conditions (v1.2) · LineUp</title>
...
<section class="terms-hero">
  <div class="container">
    ...
    <p class="terms-subtitle">{meta['subtitle']} — Version {meta['version']}</p>
    ...
    <div style="display: flex; gap: 16px; align-items: center; flex-wrap: wrap; margin-bottom: 24px;">
      <a class="download-btn" href="{meta['pdfFile']}" download="{meta['pdfFile']}">
        ...
        Download Full PDF Document (v1.2)
      </a>
    </div>
    ...
    <div class="meta-grid">
      ...
      <div class="meta-item"><span class="label">Document Version</span><span class="val">v{meta['version']}</span></div>
...
<footer class="footer">
  <div class="container footer-inner">
    ...
    <div>
      ...
      <div class="f-links">
        <a href="terms.html">Terms &amp; Conditions (v1.2)</a>
...
print('terms.html generated successfully!')
